...
class ConditionalSplitterNodeModelTest {
    ...
    @BeforeEach
    fun setUp() {
        nodeModel = ConditionalSplitterNodeModel(jacksonObjectMapper())
    ...
    fun `test node metadata is properly configured`() {
        ...
        assertEquals("org.projectcontinuum.feature.base.analytics.node.ConditionalSplitterNodeModel", metadata.id)
