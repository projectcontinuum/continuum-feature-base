...
class TimeWindowAggregatorNodeModelTest {
    ...
    @BeforeEach
    fun setUp() {
        nodeModel = TimeWindowAggregatorNodeModel(jacksonObjectMapper())
    ...
    fun `test node metadata is properly configured`() {
        ...
        assertEquals("org.projectcontinuum.feature.base.analytics.node.TimeWindowAggregatorNodeModel", metadata.id)
