...
class AnomalyDetectorZScoreNodeModelTest {
    ...
    @BeforeEach
    fun setUp() {
        nodeModel = AnomalyDetectorZScoreNodeModel(jacksonObjectMapper())
    ...
    fun `test node metadata is properly configured`() {
        ...
        assertEquals("org.projectcontinuum.feature.base.analytics.node.AnomalyDetectorZScoreNodeModel", metadata.id)
