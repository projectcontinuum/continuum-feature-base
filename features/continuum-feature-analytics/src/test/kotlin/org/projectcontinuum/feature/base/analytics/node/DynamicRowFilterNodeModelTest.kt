...
class DynamicRowFilterNodeModelTest {
    ...
    @BeforeEach
    fun setUp() {
        nodeModel = DynamicRowFilterNodeModel(jacksonObjectMapper())
    ...
    fun `test node metadata is properly configured`() {
        ...
        assertEquals("org.projectcontinuum.feature.base.analytics.node.DynamicRowFilterNodeModel", metadata.id)
