...
class TextNormalizerNodeModelTest {
    ...
    @BeforeEach
    fun setUp() {
        nodeModel = TextNormalizerNodeModel(jacksonObjectMapper())
    ...
    fun `test node metadata is properly configured`() {
        ...
        assertEquals("org.projectcontinuum.feature.base.analytics.node.TextNormalizerNodeModel", metadata.id)
