...
class CreateTableNodeModelTest {
    ...
    fun `test node metadata is properly configured`() {
        ...
        assertEquals("org.projectcontinuum.feature.base.analytics.node.CreateTableNodeModel", metadata.id)
